...
export class Equipment {
    constructor(data = {}) {
        ...
        this.identifyingNumber =
            data.identifying_number ??
            data.identifyingNumber ??
            data.truck_number ??
            data.asset_number ??
        ...
        this.conditionRating =
            data.condition_rating ?? data.conditionRating ?? data.condition ?? data.condition_score ?? null
    ...
    #heuristicFill(data) {
        ...
        if (!this.identifyingNumber) {
            const key = Object.keys(lower).find(
                (k) => k.includes('ident') || (k.includes('equip') && k.includes('num'))
            )
