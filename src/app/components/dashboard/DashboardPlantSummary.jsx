...
import {
    ...
    Skeleton,
    SummaryStrip
} from './shared/DashboardSharedComponents'
                ...
                <AIChatBubble isAI accentColor={accentColor}>
                    ...
                    <div className="flex flex-col gap-1.5">
                        {aiActionPlan.slice(0, visibleActionItems).map((item, idx) => (
                            ...
                            >
                                <span
                                    className="flex items-center justify-center w-4 h-4 rounded-full text-white flex-shrink-0 mt-0.5 text-[9px] font-bold"
