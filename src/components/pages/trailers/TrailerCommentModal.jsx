...
function TrailerCommentModal({trailerId, trailerNumber, onClose}) {
    ...
    const fetchComments = async () => {
        ...
        setError(null);
        try {
            const fetchedComments = await TrailerService.fetchComments(trailerId);
    ...
    const handleDeleteComment = async (commentId) => {
        ...
        try {
            await TrailerService.deleteComment(commentId);
            fetchComments();
        } catch (err) {
    ...
    const handleAddComment = async (e) => {
        ...
        try {
            ...
            await TrailerService.addComment(trailerId, newComment, userId);
            setNewComment('');
            fetchComments();
        } catch (err) {
        ...
        <div className="comment-modal-backdrop" onClick={handleBackdropClick}>
            <div className="comment-modal">
                <div className="comment-modal-header">
                    <h2>Comments for Trailer {trailerNumber || trailerId}</h2>
                    ...
                    <div className="comments-list">
                        ...
                        {isLoading ? (
                            ...
                            <div className="empty-comments">
                                ...
                                <p>No comments yet</p>
                                <p className="empty-subtext">Be the first to add a comment about this trailer</p>
                            </div>
                        ) : (
