...
function EquipmentCommentModal({equipmentId, equipmentNumber, onClose}) {
    ...
    const fetchComments = async () => {
        ...
        setError(null);
        try {
            const fetchedComments = await EquipmentService.fetchComments(equipmentId);
    ...
    const handleDeleteComment = async (commentId) => {
        ...
        try {
            await EquipmentService.deleteComment(commentId);
            fetchComments();
        } catch (err) {
    ...
    const handleAddComment = async (e) => {
        ...
        try {
            ...
            await EquipmentService.addComment(equipmentId, newComment, userId);
            setNewComment('');
            fetchComments();
        } catch (err) {
        ...
        <div className="comment-modal-backdrop" onClick={handleBackdropClick}>
            <div className="comment-modal">
                <div className="comment-modal-header">
                    <h2>Comments for Equipment {equipmentNumber || equipmentId}</h2>
                    ...
                    <div className="comments-list">
                        ...
                        {isLoading ? (
                            ...
                            <div className="empty-comments">
                                ...
                                <p>No comments yet</p>
                                <p className="empty-subtext">Be the first to add a comment about this equipment</p>
                            </div>
                        ) : (
