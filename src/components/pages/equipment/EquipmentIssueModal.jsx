    ...
    const handleAddIssue = async (e) => {
        ...
        try {
            ...
            if (err.message.includes('violates foreign key constraint')) {
                errorMessage += 'The equipment ID is invalid.';
                ...
                errorMessage += 'Missing required field: ' +
                    (err.message.includes('equipment_id') ? 'equipment ID' :
            ...
            try {
                localStorage.setItem('equipment_issue_error', JSON.stringify({
                    ...
                    <div className="issues-list">
                        ...
                        {isLoading ? (
                            ...
                            <div className="empty-issues">
                                ...
                                <p className="empty-subtext">This equipment has no maintenance issues on record</p>
                            </div>
                        ) : (
                            <>
