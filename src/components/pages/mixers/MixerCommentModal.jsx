...
function MixerCommentModal({mixerId, mixerNumber, onClose}) {
    ...
    const fetchComments = async () => {
        ...
        setError(null);
        try {
            const fetchedComments = await MixerService.fetchComments(mixerId);
    ...
    const handleDeleteComment = async (commentId) => {
        ...
        try {
            await MixerService.deleteComment(commentId);
            fetchComments();
        } catch (err) {
    ...
    const handleAddComment = async (e) => {
        ...
        try {
            ...
            await MixerService.addComment(mixerId, newComment, userId);
            setNewComment('');
            fetchComments();
        } catch (err) {
