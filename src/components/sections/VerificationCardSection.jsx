...
function VerificationCardSection({
    ...
    return (
        <div className="space-y-4">
            <div className={`flex items-center justify-between p-3 rounded-lg ${isVerified ? 'bg-green-50 border border-green-200' : 'bg-amber-50 border border-amber-200'}`}>
            ...
            {noticeText && (
                <div className="flex gap-2 p-3 bg-blue-50 border border-blue-200 rounded-lg">
                    ...
                    <p className="text-xs text-blue-700 leading-relaxed" dangerouslySetInnerHTML={{__html: noticeText}}></p>
                </div>
            )}
        </div>
    )
