        ...
        switch (endpoint) {
                ...
                return jsonResponse(
                    {
                        data: (plants ?? []).map((p: any) => ({
                            ...
                            districts: districtMap[p.plant_code] ?? []
                        }))
                    },
                    headers
                )
            ...
            case 'fetch-regions-by-plant-code': {
                ...
                return jsonResponse(
                    {
                        data: rows.map((r: any) => ({
                            region_code: r.regions?.region_code ?? null,
                            region_name: r.regions?.region_name ?? null,
                            type: r.regions?.type ?? null
                        }))
                    },
                    headers
                )
